package com.api.ttoklip.domain.Login.FindidAndFindpw.main.controller;

import com.api.ttoklip.domain.Login.FindidAndFindpw.main.constant.FindIdConstant;
...
import com.api.ttoklip.domain.Login.FindidAndFindpw.main.service.FindIdService;
...
public class FindIdController {
    ...
    public SuccessResponse<FindIdResponse> findUserAuth(@RequestParam FindIdRequest findIdRequest) {
        // 아이디 찾기 로직을 여기에 추가
        // 성공하면 성공 응답을, 실패하면 실패 응답을 반환
        FindIdResponse userAuth=FindIdService.findAuthByEmail(findIdRequest);
